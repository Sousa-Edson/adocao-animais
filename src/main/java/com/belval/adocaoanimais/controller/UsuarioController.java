...
public class UsuarioController {
	...
	@GetMapping("/pet/usuario/permissao/{id}")
	public ModelAndView permissaoEdit(@PathVariable Long id, RequisicaoFormUsuario requisicao) {
		Optional<Usuario> optional = this.usuarioRepository.findById(id);
		if (optional.isPresent()) {
			Usuario usuario = optional.get();
			ModelAndView mv = new ModelAndView("admin/dashboard/permissao");
	...
	@PostMapping("/pet/usuario/permissao/{id}/update")
	public ModelAndView updateEdit(@PathVariable Long id,  RequisicaoFormUsuario requisicao ) {
			...
			if (optional.isPresent()) {
				...
				usuario.setAtivo(true);
				this.usuarioRepository.save(usuario);
				return new ModelAndView("redirect:/pet/dashboard/usuarios");
	...
	// public ModelAndView editaRegistro(Usuario usuario, @RequestParam("file-img")
	...
	// Path caminho = Paths
	// .get(caminhoImagens + String.valueOf(usuario.getId()) +
	// arquivo.getOriginalFilename());
	// Files.write(caminho, bytes);
	// usuario.setCaminhoImagem(String.valueOf(usuario.getId()) +
	// arquivo.getOriginalFilename());
